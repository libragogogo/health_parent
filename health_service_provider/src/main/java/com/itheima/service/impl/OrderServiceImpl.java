...
public class OrderServiceImpl implements OrderService {
    ...
    public Result order(Map map) throws Exception{
        ...
        CompanyAddress companyAddress=orderDao.findIdByAddress(address);

        if(companyAddress==null){
            return new Result(false, MessageConstant.COMPANYADDRESS_FAIL);
        }
        ...
        addressMap.put("memberId",member.getId());
        addressMap.put("companyaddressId",companyAddress.getId());
        orderDao.setMemberAndAddress(addressMap);
