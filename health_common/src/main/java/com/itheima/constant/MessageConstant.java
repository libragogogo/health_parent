...
public class MessageConstant {
    ...
    public static final String DELETE_COMPANYADDRESS_FAIL = "删除公司地址失败";
    public static final String DELETE_COMPANYADDRESS_SUCCESS = "删除公司地址成功";
    public static final String QUERY_COMPANYADDRESS_SUCCESS = "查询公司地址成功";
    public static final String QUERY_COMPANYADDRESS_FAIL = "查询公司地址失败";
    public static final String ADD_COMPANYADDRESS_SUCCESS = "新增公司地址成功";
    public static final String ADD_COMPANYADDRESS_FAIL = "新增公司地址失败";
    public static final String COMPANYADDRESS_FAIL = "提供的公司地址错误";
    ...
    public static final String QUERY_PERMISSION_ID_SUCCESS = "查询权限ID数据成功";
    public static final String QUERY_PERMISSION_ID_FAIL = "查询权限ID数据失败";
    public static final String ADD_PERMISSION_ID_SUCCESS = "新增权限ID成功";
    public static final String ADD_PERMISSION_ID_FAIL = "新增权限ID失败";
